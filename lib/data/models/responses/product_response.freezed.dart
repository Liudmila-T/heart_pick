...
class _$ProductResponseImpl implements _ProductResponse {
  ...
  @override
  String toString() {
    return 'ProductResponse(productId: $productId, name: $name, photoUrl: $photoUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, productId, name, photoUrl);
...
abstract class _ProductResponse implements ProductResponse {
  const factory _ProductResponse(
      ...
      required final String photoUrl}) = _$ProductResponseImpl;
